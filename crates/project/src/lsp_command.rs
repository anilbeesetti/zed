...
pub(crate) fn make_text_document_identifier(uri: &lsp::Uri) -> Result<lsp::TextDocumentIdentifier> {
    Ok(lsp::TextDocumentIdentifier { uri: uri.clone() })
}
...
impl LspCommand for PrepareRename {
    ...
    fn to_lsp(
        ...
        make_lsp_text_document_position(uri, self.position)
    }
